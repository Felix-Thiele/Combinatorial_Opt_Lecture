...
private:
   ...
   bool _is_even = false;
   bool _is_odd = false;
   int is_removed = 0; ///Idee dahinter: immer die Nummer des entsprechenden Baums zuordnen, dann kann man
   ///beim unshrinken besser unterscheiden, was man grade vor sich hat
